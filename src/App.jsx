...
const STUDIO_THEMES = {
  ...
  light: {
    name: 'Lacoste Light Factory',
    bg: 'radial-gradient(ellipse at 50% 40%, #ffffff 0%, #eaedf5 55%, #c8d0e0 100%)',
    textColor: '#0f172a',
    svgFill: '#0f172a'
  },
  gold: {
...
function App() {
  ...
  return (
    <>
      <main style={{ color: currentTheme.textColor, transition: 'color 0.4s ease' }}>
        <Canvas style={{
          height: "100vh",
          width: "100vw",
          position: "fixed",
        ...
        <section id='section-1' >
          <nav>
            <div className="nav-elem">
              <svg xmlns="http://www.w3.org/2000/svg" fill={currentTheme.svgFill} style={{ transition: 'fill 0.4s ease' }} viewBox="0 0 401.23099 116.838">
            ...
            {/* Lacoste Studio Lighting Theme Switcher */}
            <div className="nav-elem theme-switcher">
